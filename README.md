...
If you try to spawn more than 10, you will lose all of your precious cats! (no worries, you u re-spawn some more)*<br><br><h2>***Live demo☕️  from some gameplay from my Samsung Galaxy 3  :*** </h2> I used [this awsome Video to Giff maker website](https://gifs.com/) and uploaded the giff using code generated from [creating new issue within Github](https://help.github.com/articles/creating-an-issue/) . **Note:** GitHub restricts files above 10mb.<br><br>
